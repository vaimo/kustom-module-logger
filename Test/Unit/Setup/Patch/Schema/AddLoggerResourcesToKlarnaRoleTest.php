...
namespace Klarna\Logger\Test\Unit\Setup\Patch\Schema;

use Klarna\Logger\Setup\Patch\Schema\AddLoggerResourcesToKlarnaRole;
 ...
 * @coversDefaultClass \Klarna\Logger\Setup\Patch\Schema\AddLoggerResourcesToKlarnaRole
 */
class AddLoggerResourcesToKlarnaRoleTest extends TestCase
{
    ...
    {
        $this->addKlarnaUserAndRole = parent::setUpMocks(AddLoggerResourcesToKlarnaRole::class);
